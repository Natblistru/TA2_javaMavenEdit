...
public class MainStageController implements Initializable {
    ...
    public void onEdit() throws IOException {
        ...
        if (selectedEmployee != null) {
            ...
            controller.setEmployee(selectedEmployee); // Transmiterea employee ales in EditDialogController
            editDialog.showAndWait();

            Employee editedEmployee = controller.getResult();

            if (editedEmployee != null) {
                employeeDB.update(editedEmployee); // todo: Обрабатывать ошибки
